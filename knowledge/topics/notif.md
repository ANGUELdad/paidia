...
> [!abstract] Snippet
> Local Notification API + platform matrix. Optional VAPID subscribe when keys set. See NOTIFICATIONS_MATRIX.md.

## Keywords
`notification`, `mitteilung`, `push`, `presence`, `sweep`

## Open these files (only)
- `app.js`
- `sw.js`
- `docs/agents/WEB_PUSH_LATER.md`
