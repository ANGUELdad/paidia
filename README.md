...
Lilly, Daniel και Leonie. Οι Julian groß, Lea και Valeria σημειώνονται ως παιδιά από
**άλλο / εξωτερικό σπίτι** και δεν αποκτούν ψεύτικη αντιστοίχιση σε Villa ή Limenaria.
Παραμένουν διαθέσιμα σε δραστηριότητες, events και child profiles. **Ομάδες** όπως
