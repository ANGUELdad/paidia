...
| Child portal and separate PIN entry | Covered in prototype with server-only salted PIN hashes, rate-limited login, a 12-hour HttpOnly session, and one-time email reset links; production identity lifecycle and shared session storage remain. |
